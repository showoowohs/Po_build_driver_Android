        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case STARTED:   {
                    ...
                    if (!ret) {
			    Log.e(TAG, "[Benson] Error while turning Bluetooth On");
			if(SystemProperties.get("bluetooth.halstatus").equals("-4")){
				Log.e(TAG, "[Benson] bluetooth.halstatus=-4");

				SystemProperties.set("bluetooth.halstatus", "0");
				Log.e(TAG, "[Benson] bluetooth.halstatus -----> 0");
				int id= android.os.Process.myPid();
				Log.e(TAG, "[Benson] Bluetooth kill pid=" + id);
